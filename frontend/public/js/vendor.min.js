'use strict';
(self.webpackChunkgulp = self.webpackChunkgulp || []).push([
  [736],
  {
    689: (t, e, i) => {
      i.d(e, { lr: () => x });
          ...
          return (
            ...
            ((function (t) {
              const e = getComputedStyle(t)['overflow-y'],
                ...
                s =
                  ('scroll' === e || 'auto' === e) && Math.abs(t.scrollHeight - t.clientHeight) > 1,
      ...
      const l = (t, e) =>
        ...
        c = (t, e) =>
          e ? { clientX: (t.clientX + e.clientX) / 2, clientY: (t.clientY + e.clientY) / 2 } : t;
      class d {
          ...
          (this._element = t),
            ...
            (this._touchStart = (t) => {
              for (const e of Array.from(t.changedTouches || []))
                this._triggerPointerStart(new h(e), t);
            }),
            (this._move = (t) => {
              const e = this.currentPointers.slice(),
                i = ((t) => 'changedTouches' in t)(t)
                  ? Array.from(t.changedTouches).map((t) => new h(t))
                  : [new h(t)];
              for (const t of i) {
      ...
      class u {
        ...
        attachPlugins(t) {
          ...
          for (const [i, s] of Object.entries(t || {}))
            !1 === this.options[i] ||
              this.plugins[i] ||
              ((this.options[i] = o({}, s.defaults || {}, this.options[i])), (e[i] = new s(this)));
      ...
      class g extends u {
        constructor(t, e = {}) {
          super(o(!0, {}, f, e)), (this.state = 'init'), (this.$container = t);
          ...
          const t = new d(this.$container, {
            ...
            move: (e, i, s) => {
              ...
              if (
                ...
                return;
              if (i.length > 1 && (!this.option('zoom') || !1 === this.option('pinchToZoom')))
                return;
              const o = c(e[0], e[1]),
                n = c(i[0], i[1]),
              ...
              if ('xy' === f || 'y' !== this.lockAxis) {
                if (
                  ...
                  const e = c(t.startPointers[0], t.startPointers[1]),
              ...
              if (this.transform.scale - o > 0.01) {
                ...
                this.zoomTo(o, { friction: 0.64, x: t.clientX - i.left, y: t.clientY - i.top });
              }
            },
          });
        ...
        updateMetrics(t) {
          ...
          (c = n(c * f)), (u = n(u * f)), (h = c), (l = u);
          const g = i.getBoundingClientRect(),
            p = s.getBoundingClientRect(),
            m = s == e ? p : e.getBoundingClientRect();
          let y = Math.max(s.offsetWidth, n(p.width)),
            v = Math.max(s.offsetHeight, n(p.height)),
          ...
          if (
            ...
            if (Math.abs(c - g.width) > 0.1 || Math.abs(u - g.height) > 0.1) {
              ...
              (h = n(t.width)), (l = n(t.height));
            }
            Object.assign(i.style, { width: `${h}px`, height: `${l}px`, transform: '' });
          }
          if (
            (r &&
              (Object.assign(s.style, { width: `${h}px`, height: `${l}px` }),
        ...
        setTransform(t) {
          ...
          if (
            ...
            (t = n(this.content.fitWidth * s)),
              ...
              (this.transform = { ...this.transform, width: t, height: o, scale: s }),
      ...
      class x extends u {
        ...
        updateMetrics() {
          let t,
            e = 0,
            i = [];
          this.slides.forEach((s, o) => {
            const n = s.$el,
              a = s.isDom || !t ? this.getSlideMetrics(n) : t;
            (s.index = o), (s.width = a), (s.left = e), (t = a), (e += a), i.push(o);
          });
          ...
          if (Number.isInteger(r) && e > s)
            for (let t = 0; t < this.slides.length; t += r)
              a.push({ indexes: i.slice(t, t + r), slides: this.slides.slice(t, t + r) });
          else {
            let t = 0,
              e = 0;
            for (let i = 0; i < this.slides.length; i += 1) {
              let o = this.slides[i];
              (!a.length || e + o.width > s) &&
        ...
        setPage(t, e) {
          ...
          if (
            ((t = ((s % a) + a) % a), this.option('infiniteX', this.option('infinite')) && r > h)
          ) {
          ...
          return (
            ...
            null !== o &&
              t !== o &&
              ((this.prevPage = o), (this.prevPageIndex = n), this.trigger('change', t, o)),
            i
          );
        }
        destroy() {
        ...
        S = (t) => {
          if (t && w) {
            ...
            try {
              ...
              else if ($) t.focus({ preventScroll: !0 });
              else {
      ...
      class T {
        ...
        processType(t) {
          ...
          if (!e || 'string' == typeof e) {
            if (
              ...
              const o = P(e, this.fancybox.option('Html.youtube')),
              ...
              const o = P(e, this.fancybox.option('Html.vimeo')),
                n = encodeURIComponent(s[1]);
              (t.videoId = n),
            ...
            i ||
              ('#' === e.charAt(0)
                ...
                ? ((i = 'html5video'),
                  (t.format = t.format || 'video/' + ('ogv' === s[1] ? 'ogg' : s[1])))
                : e.match(
        ...
        onReady() {
          this.fancybox.Carousel.slides.forEach((t) => {
            t.$el &&
              (this.setContent(t), t.index === this.fancybox.getSlide().index && this.playVideo(t));
          });
        }
        onCreateSlide(t, e, i) {
      ...
      class _ {
        ...
        canZoom(t) {
          ...
          if (this.fancybox.option('Image.ignoreCoveredThumbnail')) {
            ...
            n = document.elementFromPoint(o.left + 0.5 * o.width, o.top + 0.5 * o.height) === s;
      ...
      class A {
        ...
        static startFromUrl() {
          ...
          const { hash: e, slug: i, index: s } = A.getParsedURL();
          if (!i) return;
        ...
        static onHashChange() {
          const { slug: t, index: e } = A.getParsedURL(),
            i = A.Fancybox,
            s = i && i.getInstance();
          if (s && s.plugins.Hash) {
            if (t) {
        ...
        static getParsedURL() {
          const t = window.location.hash.substr(1),
            e = t.split('-'),
            i =
              (e.length > 1 && /^\+?\d+$/.test(e[e.length - 1]) && parseInt(e.pop(-1), 10)) || null;
      ...
      class M {
        ...
        onPrepare() {
          ...
          if (
            ...
            (this.build(),
            this.update(),
            (this.Slideshow = new k(t)),
            !t.Carousel.prevPage &&
              (t.option('slideshow.autoStart') && this.Slideshow.activate(),
              t.option('fullscreen.autoStart') && !z.element()))
          )
            try {
              z.activate(t.$container);
            } catch (t) {}
        }
        onFsChange() {
        ...
        build() {
          ...
          for (const n of this.fancybox.option('Toolbar.display')) {
            let a, r;
            if (
              (s(n) ? ((a = n.id), (r = o({}, t[a], n))) : ((a = n), (r = t[a])),
        ...
        update() {
          ...
          for (const e of this.fancybox.$container.querySelectorAll('[data-fancybox-index]'))
            e.innerHTML = t.index + 1;
          for (const t of this.fancybox.$container.querySelectorAll('[data-fancybox-count]'))
            t.innerHTML = i;
          ...
          ScrollLock: class {
            ...
            updateViewport() {
              ...
              i - 1 > 0.1 &&
                ((o = e.width * i + 'px'),
                (n = e.height * i + 'px'),
                (a = `translate3d(${e.offsetLeft}px, ${e.offsetTop}px, 0) scale(${1 / i})`)),
                (s.style.width = o),
                (s.style.height = n),
                (s.style.transform = a);
            }
      ...
      class D extends u {
        constructor(t, e = {}) {
          (t = t.map(
            (t) => (t.width && (t._width = t.width), t.height && (t._height = t.height), t),
          )),
            super(o(!0, {}, F, e)),
            this.bindHandlers(),
            (this.state = 'init'),
        ...
        setItems(t) {
          ...
          for (const i of t) {
            ...
            if (!s) {
              ...
              t &&
                (s = t instanceof HTMLImageElement ? t : t.querySelector('img:not([aria-hidden])')),
                !s &&
                  i.$trigger &&
                  (s =
        ...
        onClick(t) {
          ...
          if (e.matches('[data-fancybox-close]')) return t.preventDefault(), void D.close(!1, t);
          if (e.matches('[data-fancybox-next]')) return t.preventDefault(), void D.next();
          if (e.matches('[data-fancybox-prev]')) return t.preventDefault(), void D.prev();
          if (
            (e.matches(C) || document.activeElement.blur(),
        ...
        onKeydown(t) {
          if (D.getInstance().id !== this.id) return;
        ...
        focus(t) {
          ...
          t && t.preventDefault(), (D.ignoreFocusChange = !0);
          ...
          t
            ...
            ? S(n)
            : a.indexOf(document.activeElement) < 0 && S(e),
        ...
        close(t) {
          if (
            (t && t.preventDefault(), ['closing', 'customClosing', 'destroy'].includes(this.state))
          )
            return;
        ...
        static fromEvent(t, e = {}) {
          ...
          let s,
            ...
            a = i;
          if (
            ((a.matches('[data-fancybox-trigger]') || (a = a.closest('[data-fancybox-trigger]'))) &&
          ...
          let r = !1;
          if (o) {
            (e.event = t), (e.target = n), (n.origTarget = i), (r = D.fromOpener(o, e));
        ...
        static fromOpener(t, e = {}) {
          let i = [],
            s = e.startIndex || 0,
            n = e.target || null;
          const a = void 0 !== (e = o({}, e, D.openers.get(t))).groupAll && e.groupAll,
          ...
          if ((n && !a && (i = h ? i.filter((t) => t.getAttribute(`${r}`) === h) : [n]), !i.length))
            return !1;
          ...
          return (
            ...
            new D(i, o({}, e, { startIndex: s, $trigger: n })))
          );
        }
        static bind(t, e = {}) {
          function i() {
        ...
        static unbind(t) {
          D.openers.delete(t), D.openers.size || D.destroy();
        }
        static destroy() {
          let t;
          for (; (t = D.getInstance()); ) t.destroy();
        ...
        static getInstance(t) {
          return t
            ...
            : Array.from(R.values())
                .reverse()
                .find((t) => !['closing', 'customClosing', 'destroy'].includes(t.state) && t) ||
                null;
        }
        static close(t = !0, e) {
      ...
      (D.version = '4.0.26'),
        ...
        (D.openers = new Map()),
        (D.Plugins = I),
        D.bind('[data-fancybox]');
      for (const [t, e] of Object.entries(D.Plugins || {}))
        'function' == typeof e.create && e.create(D);
    },
  },
]);
